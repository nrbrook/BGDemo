...
#define BUTTON_LED0_PIN         (6)
#define BUTTON_LED0_PORT        (gpioPortF)

#define BUTTON_LED1_PIN         (7)
#define BUTTON_LED1_PORT        (gpioPortF)

#define BUTTON_LED2_PIN         (4)
#define BUTTON_LED2_PORT        (gpioPortF)

#define BUTTON_LED3_PIN         (1)
#define BUTTON_LED3_PORT        (gpioPortA)
